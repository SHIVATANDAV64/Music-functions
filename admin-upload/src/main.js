    ...
    try {
        ...
        switch (contentType) {
            case 'track': {
                ...
                try {
                    const track = await databases.createDocument(DATABASE_ID, 'tracks', ID.unique(), trackDoc);
            ...
            case 'podcast': {
                ...
                try {
                    const podcast = await databases.createDocument(DATABASE_ID, 'podcasts', ID.unique(), {
            ...
            case 'episode': {
                ...
                try {
                    ...
                    const episode = await databases.createDocument(DATABASE_ID, 'episodes', ID.unique(), {
